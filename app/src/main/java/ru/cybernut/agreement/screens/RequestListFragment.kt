...
class RequestListFragment : Fragment(), KoinComponent, ActionModeController.Approvable {
        ...
        tracker.addObserver(object : SelectionTracker.SelectionObserver<Request>() {
            override fun onSelectionChanged() {
                ...
                if (tracker.hasSelection() && actionMode == null) {
                    actionMode = (activity as AppCompatActivity)?.startSupportActionMode(ActionModeController(tracker, this@RequestListFragment))
